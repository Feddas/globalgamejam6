...
public class TargetPathingGameObject : MonoBehaviour {
	...
	void SetTargetOjbectAndTargetPosition(GameObject newTargetObject, Vector2 newTargetPosition) {
		targetObject = newTargetObject;
		targetPosition = newTargetPosition;
	}

	Vector2 CalculateNextMovementStep() {
	...
	bool hasTargetObjectArrivedAtLocation() {
		if(this.gameObject.transform.position.x == targetPosition.x
